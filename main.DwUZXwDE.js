import{C as L,t as u,S as g,G as K,f as H,D as P,L as ft,E as xt}from"./assets/EventRepository-OUthFii9.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const r of a.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&i(r)}).observe(document,{childList:!0,subtree:!0});function e(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(s){if(s.ep)return;s.ep=!0;const a=e(s);fetch(s.href,a)}})();let _="x",I=[];function yt(o){_=o}function d(o,t,e){I.push(()=>{window.customElements.define(`${_}-${o}`,t,e)})}function vt(){for(const o of I)o();I=[]}function l(){return _}function n(o){return`var(--${l()}-${o})`}function kt(){document.addEventListener("DOMContentLoaded",function(){const o=`${l()}-theme`,t=document.querySelector(o);if(!t)throw new Error(`Not theme tag found: ${o}`);if(t.style.display!=="none")throw new Error('Theme tag needs inline style of "display: none"  for the wait functionality to work.');t&&customElements.get(o)?t.style.display="":customElements.whenDefined(o).then(()=>{t.style.display=""})})}var $=(o=>(o[o.XS=480]="XS",o[o.MD=600]="MD",o[o.LG=960]="LG",o[o.XL=1280]="XL",o))($||{}),C=(o=>(o.LIGHT="light",o.DARK="dark",o.AUTO="auto",o))(C||{});function x(o){let t=0,e=0,i=0;return o.length===4?(t=parseInt(o[1]+o[1],16),e=parseInt(o[2]+o[2],16),i=parseInt(o[3]+o[3],16)):o.length===7&&(t=parseInt(o[1]+o[2],16),e=parseInt(o[3]+o[4],16),i=parseInt(o[5]+o[6],16)),`${t}, ${e}, ${i}`}function h(o,t){let e=!1;o[0]==="#"&&(o=o.slice(1),e=!0);const i=parseInt(o,16);let s=(i>>16)+t;s=s>255?255:s<0?0:s;let a=(i>>8&255)+t;a=a>255?255:a<0?0:a;let r=(i&255)+t;return r=r>255?255:r<0?0:r,(e?"#":"")+(16777216+(s<<16)+(a<<8)+r).toString(16).slice(1)}function wt(o,t,e,i,s){function a(r,c,p,b){const v=b?60:-60,E=x(r),k=x(c),w=x(p);return{primary:{50:h(r,100),100:h(r,70),200:h(r,50),300:h(r,30),400:h(r,20),500:r,600:h(r,-10),700:h(r,-20),800:h(r,-30),900:h(r,-50)},secondary:{50:h(r,-100),100:h(r,-70),200:h(r,-50),300:h(r,-30),400:h(r,-20),500:h(r,-10),600:h(r,-20),700:h(r,-30),800:h(r,-40),900:h(r,-50)},background:{50:h(c,100),100:h(c,70),200:h(c,50),300:h(c,30),400:h(c,20),500:c,600:h(c,-10),700:h(c,-20),800:h(c,-30),900:h(c,-50),1e3:h(c,-80)},neutral:{background:c,text:p,border:h(c,v)},rgb:{primary:E,secondary:x(h(r,-20)),background:k,text:w,border:x(h(c,v))}}}return{light:a(o,e,t,!1),dark:a(o,s,i,!0)}}function $t(o){function t(i){const{primary:s,secondary:a,neutral:r,rgb:c,background:p}=o[i];return`
      --${i}-primary-50: ${s[50]};
      --${i}-primary-100: ${s[100]};
      --${i}-primary-200: ${s[200]};
      --${i}-primary-300: ${s[300]};
  ...
  `}class Et extends HTMLElement{constructor(){super(),this.styleElement=void 0,this.defaultStyles={fontSizeTitle:"4.25rem",fontSizeXxl:"2rem",fontSizeXl:"1.75rem",fontSizeLg:"1.5rem",fontSizeMd:"1.125rem",fontSizeSm:"0.975rem",fontSizeXs:"0.85rem",fontSizeDefault:"1rem",fontFamilyDefault:"sans-serif",fontFamilyHeading:"arial",colorPrimary:"#ed1c24",colorTextLight:"#000000",colorTextDark:"#ffffff",colorBackgroundLight:"#ffffff",colorBackgroundDark:"#000000",cardMediaSizeSmall:"24px",cardMediaSizeMedium:"64px",cardMediaSizeLarge:"128px",appBarHeight:"64px",bottomNavigationHeight:"72px",bottomNavigationOffset:"0px"},this.shadow=this.attachShadow({mode:"open"});const t=document.createElement("slot");this.shadow.append(t),this.updateStyles()}static get observedAttributes(){return["font-family-heading","font-family-default","font-size-title","font-size-xxl","font-size-xl","font-size-lg","font-size-md","font-size-sm","font-size-default","color-primary","color-text-dark","color-background-dark","color-text-light","color-background-light","card-media-size-sm","card-media-size-md","card-media-size-lg","app-bar-height","bottom-navigation-height"]}attributeChangedCallback(){this.updateStyles()}updateStyles(){const t=this.getAttribute("font-size-title")||this.defaultStyles.fontSizeTitle,e=this.getAttribute("font-size-xxl")||this.defaultStyles.fontSizeXxl,i=this.getAttribute("font-size-xl")||this.defaultStyles.fontSizeXl,s=this.getAttribute("font-size-lg")||this.defaultStyles.fontSizeLg,a=this.getAttribute("font-size-md")||this.defaultStyles.fontSizeMd,r=this.getAttribute("font-size-sm")||this.defaultStyles.fontSizeSm,c=this.getAttribute("font-size-xs")||this.defaultStyles.fontSizeXs,p=this.getAttribute("font-size-default")||this.defaultStyles.fontSizeDefault,b=this.getAttribute("font-family-default")||this.defaultStyles.fontFamilyDefault,v=this.getAttribute("font-family-heading")||this.defaultStyles.fontFamilyHeading,E=this.getAttribute("color-primary")||this.defaultStyles.colorPrimary,k=this.getAttribute("color-text-light")||this.defaultStyles.colorTextLight,w=this.getAttribute("color-text-dark")||this.defaultStyles.colorTextDark,A=this.getAttribute("color-background-light")||this.defaultStyles.colorBackgroundLight,lt=this.getAttribute("color-background-dark")||this.defaultStyles.colorBackgroundDark,dt=this.getAttribute("card-media-size-lg")||this.defaultStyles.cardMediaSizeLarge,ct=this.getAttribute("card-media-size-md")||this.defaultStyles.cardMediaSizeMedium,ht=this.getAttribute("card-media-size-sm")||this.defaultStyles.cardMediaSizeSmall,ut=this.getAttribute("app-bar-height")||this.defaultStyles.appBarHeight,pt=this.getAttribute("bottom-navigation-height")||this.defaultStyles.bottomNavigationHeight,gt=this.getAttribute("bottom-navigation-offset")||this.defaultStyles.bottomNavigationOffset,mt=wt(E,k,A,w,lt),bt=$t(mt);this.styleElement&&this.shadow.removeChild(this.styleElement),this.styleElement=document.createElement("style"),this.styleElement.textContent=`
    ...
    `}class R extends HTMLElement{constructor(){super();const t=this.attachShadow({mode:"open"}),e=document.createElement("style");e.textContent=`
        ...
        `,t.appendChild(e);const i=document.createElement("slot");t.appendChild(i)}}d("card-content",Z);class Mt extends HTMLElement{constructor(){super();const t=this.attachShadow({mode:"open"}),e=document.createElement("style");e.textContent=`
            :host {
                box-sizing: border-box;
                border: 1px solid var(--semantic-stroke-default);
                display: flex;
        ...
        `,t.appendChild(e);const i=document.createElement("slot");t.append(i)}}d("bare-link",jt);class z extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"});const t=document.createElement("style");t.textContent=`          
            :host {
              display: inline;
            }
        ...
        `,this.shadow.appendChild(t);const e=document.createElement("slot");this.shadow.appendChild(e)}set display(t){this.setAttribute("display",t)}get display(){return this.getAttribute("display")||""}static get observedAttributes(){return["display"]}}d("typography",z);class Nt extends HTMLElement{constructor(){super();const t=this.attachShadow({mode:"open"}),e=document.createElement("style");e.textContent=`
            :host {
                display: block;
                background-color: var(--semantic-background-default);
                color: var(--semantic-text-default);
    ...
    `,this.shadow.appendChild(t);const e=document.createElement("slot");this.shadow.appendChild(e)}static get observedAttributes(){return["size","width","height"]}attributeChangedCallback(t,e,i){e!==i&&["size","width","height"].includes(t)&&this.updateImageSize()}updateImageSize(){const t=this.querySelector("img"),e=this.getAttribute("width")||void 0,i=this.getAttribute("height")||void 0;e&&(t.style.width=e),i&&(t.style.height=i)}}d("figure",qt);class Dt extends HTMLElement{constructor(){super();const t=document.createElement("style");t.textContent=`
            ...
            ${y()}
      `;const e=this.attachShadow({mode:"open"});e.appendChild(t);const i=document.createElement("slot");e.appendChild(i)}}d("block",Dt);class _t extends HTMLElement{constructor(){super();const t=this.attachShadow({mode:"open"});this.button=document.createElement("button"),this.button.classList.add("button");const e=document.createElement("style");e.textContent=`
      :host {
        width: max-content;
        height: max-content;
      }
    ...
    `,this.shadow.appendChild(t)}static get observedAttributes(){return["size","svg"]}attributeChangedCallback(t,e,i){e!==i&&i&&t==="svg"&&this.loadSvg(i)}async loadSvg(t){try{if(M.svgCache.has(t))this.setSvgContent(M.svgCache.get(t));else{const e=await fetch(t);if(!e.ok)throw new Error(`Failed to load SVG: ${e.statusText}`);const i=await e.text();M.svgCache.set(t,i),this.setSvgContent(i)}}catch(e){console.error("Error loading SVG:",e)}}setSvgContent(t){const e=document.createElement("div");e.innerHTML=t;const i=e.querySelector("svg");if(i){if(i.removeAttribute("width"),i.removeAttribute("height"),!i.hasAttribute("viewBox")){const s=i.getAttribute("width")||"100",a=i.getAttribute("height")||"100";i.setAttribute("viewBox",`0 0 ${s} ${a}`)}this.shadow.appendChild(i)}else console.error("No valid SVG element found in the provided content.")}};st.svgCache=new Map;let j=st;d("icon",j);class Ft extends HTMLElement{constructor(){super();const t=this.attachShadow({mode:"open"}),e=document.createElement("style");e.textContent=`
      :host {
        display: block;
        padding: 0;
        margin: 0;
    ...
    `;const e=this.getAttribute("svg");if(e){const s=document.createElement("div");s.className="icon-container",this.icon=new j,this.icon.setAttribute("svg",e),this.icon.setAttribute("size","none"),this.icon.className="icon",s.appendChild(this.icon),this.shadow.appendChild(s)}const i=new z;i.className="label",i.setAttribute("display","h6"),i.textContent=this.getAttribute("label")||"",this.getAttribute("label")||this.setAttribute("no-label",""),this.shadow.appendChild(t),this.shadow.appendChild(i)}static get observedAttributes(){return["svg"]}attributeChangedCallback(t,e,i){if(t==="svg"&&e!==i){const s=this.shadow.querySelector(".icon-container");this.icon?i?this.icon.setAttribute("svg",i):(s&&s.removeChild(this.icon),this.icon=void 0):i&&(this.icon=new j,this.icon.setAttribute("svg",i),this.icon.className="icon",s&&s.appendChild(this.icon))}}}d("bottom-navigation-action",ee);class m extends HTMLElement{static routes=[];constructor(){super(),window.addEventListener("hashchange",()=>this.update()),this.update()}static unregister(t){this.routes=this.routes.filter(e=>e!==t)}static register(t){this.routes.push(t),t.isMatchingPath()?t.show():t.hide()}static current(){return window.location.hash.slice(1)}update(){m.routes.forEach(t=>{t.isMatchingPath()?t.show():t.hide()})}connectedCallback(){this.update()}static default(){return m.routes.find(t=>t.isDefault)}static exists(t){return m.routes.some(e=>e.path===t)}}function at(){const o=navigator.userAgent;return/iPhone|iPad|iPod/i.test(o)?/Safari/i.test(o)&&!/CriOS|FxiOS/i.test(o):/Macintosh/i.test(o)?/Safari/i.test(o)&&!/Chrome/i.test(o):!1}function ie(){history.pushState(null,"",location.href),window.onpopstate=()=>{history.go(1)}}let q,D=!1;async function nt(){return window.matchMedia("(display-mode: standalone)").matches||"standalone"in window.navigator&&window.navigator.standalone?!0:"getInstalledRelatedApps"in navigator&&typeof navigator.getInstalledRelatedApps=="function"?(await navigator.getInstalledRelatedApps()).length>0:!1}function se(){window.addEventListener("beforeinstallprompt",o=>{o.preventDefault(),q=o,console.log("Install prompt event detected")})}function Y(o=5e3){return new Promise(t=>{const e=Date.now(),i=()=>{q?t(q):Date.now()-e<o?setTimeout(i,100):t(void 0)};i()})}function oe(){"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/service-worker.js",{scope:"/",type:"module"}).then(e=>{console.log("ServiceWorker registration successful with scope: ",e.scope),e.waiting&&(D=!0),e.onupdatefound=()=>{const i=e.installing;i&&(i.onstatechange=()=>{i.state==="installed"&&(D=!0)})}}).catch(e=>{console.log("ServiceWorker registration failed: ",e)})})}function ae(){return new Promise(o=>{setTimeout(()=>{o(D)},1e3)})}class rt extends HTMLElement{shadow;snackbarContainer;constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),this.shadow.innerHTML=`
        ...
        `,this.snackbarContainer=this.shadow.querySelector("#snackbar-container")}connectedCallback(){(async()=>(setTimeout(()=>{const t=this.shadow.querySelector("#splash");t&&(t.classList.add("fade-out"),t.addEventListener("transitionend",()=>{t.remove()}))},L.SPLASH_TIMEOUT),this.networkStatusListener(),this.activeBottomNavigation(),await nt()||this.installationInstructions()))()}activeBottomNavigation(){const t=this.shadow.querySelectorAll("x-bottom-navigation > x-bare-link > a");if(t.length===0)return;const e=()=>{const s=m.current();for(const a of t){const r=a.href.split("#")?.[1],c=a.querySelector("x-bottom-navigation-action");c&&(r===s?c.setAttribute("active",""):c.removeAttribute("active"))}},i=()=>{m.current()||(window.location.hash="#games"),e()};window.addEventListener("hashchange",e),window.addEventListener("popstate",e),i()}installationInstructions(){if(at()){let t=this.snackbarContainer.querySelector("#installation-instructions");if(!t){const e=new G;e.id="installation-instructions",e.setAttribute("position","left"),e.setAttribute("stretch-horizontal",""),e.setAttribute("fixed",""),e.setAttribute("offset","bottom-navigation"),e.setAttribute("closable",""),e.innerHTML=`
        ...
        `}renderGameCards(t){return t.map(e=>`
            ...
            `:""}update(){const t=this.getAttribute("home")||"",e=this.getAttribute("away")||"",i=this.hasAttribute("homeScore")?Number.parseInt(this.getAttribute("homeScore")||"0"):0,s=this.hasAttribute("awayScore")?Number.parseInt(this.getAttribute("awayScore")||"0"):0,a=this.getAttribute("status")||"",r=this.getAttribute("homeLogo")||"",c=this.getAttribute("awayLogo")||"",p=this.getAttribute("background")||void 0,b=this.getAttribute("league")||"",v=this.getAttribute("venue")||"",E=this.getAttribute("date")||new Date("1970"),k=new Date(E);let w="";const A=["canceled","forfeit","suspended","canceled"].includes(a);p&&(w=`
                background-image: 
                ...
                <x-box margin-inline="small" margin-block="small">
                    ...
                    <x-stack gap="small" margin-block="medium" margin-inline="medium" direction="vertical">
                        ...
                        <x-typography display="overline">
                            ${u("app.settings.version")} 0.0.12-beta
                        </x-typography>
    ...
    `,t.append(i)}}class ue extends HTMLElement{shadow;constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),this.shadow.innerHTML=`
        ...
        `}connectedCallback(){(async()=>{if(await nt()||!await Y())return;const t=this.shadow.querySelector("#top-right");t.innerHTML=`
                <x-icon id="install" size="medium" svg="/icons/download.svg"></x-icon>
            `,t.querySelector("#install").addEventListener("click",async()=>{const i=await Y();i&&(await i.prompt(),i.userChoice.then(s=>{if(s.outcome==="accepted")console.log("User accepted the A2HS prompt");else{console.log("User dismissed the A2HS prompt");return}window.location.reload()}))})})()}}class pe extends HTMLElement{shadow;constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),this.shadow.innerHTML=`
            <style>
                :host {
                    display: flex;
                }
        ...
        `}}se();yt("x");kt();vt();customElements.define("hb-soft-auth",ce);customElements.define("hb-loading",pe);customElements.define("hb-splash",he);customElements.define("hb-route",le);customElements.define("hb-router",m);customElements.define("hb-shell",rt);customElements.define("hb-header",ue);customElements.define("hb-settings-page",re);customElements.define("hb-games-page",ne);customElements.define("hb-events-page",de);customElements.define("hb-game-card",W);customElements.define("hb-event-card",X);oe();g.load();document.querySelector("x-container")?.append(new rt);document.querySelector("x-theme")?.setAttribute("theme",g.getTheme());at()&&ie();
